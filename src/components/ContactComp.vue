<template>
    ...
    <div class="fun">
        <h4 class="h4">Thank you for stopping by ClayExpressions, hope you enjoyed your stay. See you next time!</h4>
        <button class="btn"><router-link to="/">back to the home page</router-link></button>
    </div>
</template>
...
.login-card {
  ...
  border-radius: 10px;
  background-image: url("https://i.postimg.cc/zfhGcvkn/chloe-bolton-R0qth-Xq3jec-unsplash.jpg");
